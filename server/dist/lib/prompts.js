...
exports.practiceExamGenerator = practiceExamGenerator;
exports.practiceExamEssayGrader = practiceExamEssayGrader;
exports.outlineBuilder = outlineBuilder;
...
function practiceExamGenerator(course, difficulty, questionCount) {
...
function practiceExamEssayGrader(course, question, answer) {
    return [
        {
            role: "system",
...
// ── Outline Builder ───────────────────────────────────────────────────────────
function outlineBuilder(course, readingsContent) {
    return [
        {
            role: "system",
...
// ── Glossary Extractor ────────────────────────────────────────────────────────
function glossaryExtractor(course, readingContent, readingTitle) {
    return [
        {
            role: "system",
